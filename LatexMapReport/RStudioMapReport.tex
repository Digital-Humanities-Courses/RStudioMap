...
\fancyhead[R]{\includegraphics[width=2cm]{logo_pant.jpg}} % Add your logo image if needed
\fancyfoot[C]{\thepage}

% Title Formatting with Modern Font
\renewcommand{\rmdefault}{ppl} % Default serif font
...
\title{
    \vspace{0cm} % Adjusted for tighter layout
    \begin{flushleft} 
    \textbf{\huge \sffamily Visualization of Shakespeare's Cities} \\[0.5cm] % Modern font for the title
    \end{flushleft}
    ...
    \vspace{1cm} % Reduced bottom space
}
\author{}
\date{}
...
% Title page with yellow stylings
\maketitle

% Add a brief introductory section on the first page
\noindent
...
\begin{center}
    \includegraphics[width=0.8\linewidth]{RStudioMap.png} \\[0.5cm] % Insert a relevant image of the map
    \textcolor{shakespeareyellow}{\rule{0.8\linewidth}{0.5mm}} % Horizontal line to enhance layout
\end{center}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{MapPopUps.png} % Replace with your map image path
